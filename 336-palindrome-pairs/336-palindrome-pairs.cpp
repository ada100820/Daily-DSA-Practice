...
--> For each word, we can check if the current node is a palindrome, if so, we can add all the words in the current node
    to the answer.
--> We can also check if the current node is a prefix of the current word, if so, we can check if the remaining part of
    the word is a palindrome, if so, we can add the current word to the answer.
--> We can also check if the current node is a suffix of the current word, if so, we can check if the remaining part of
    the word is a palindrome, if so, we can add the current word to the answer.
